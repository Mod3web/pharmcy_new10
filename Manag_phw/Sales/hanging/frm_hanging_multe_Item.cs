...
{
    public partial class frm_hanging_multe_Item : Form
    {
        public frm_hanging_multe_Item()
        {
            InitializeComponent();
        }
        DataTable dt;
        private void Frm_hanging_multe_Item_Load(object sender, EventArgs e)
        {
        ...
        {
            var vr = Application.OpenForms["Main"] as Main;
            new Sales.hanging_Add_Delete_update_serch().fill_Com_((int)dgv_multy_Item_dgv.CurrentRow.Cells[0].Value, (int)dgv_multy_Item_dgv.CurrentRow.Cells[7].Value,(int)com_unit.SelectedValue);
            ...
            new Sales.hanging_Add_Delete_update_serch().Item_count_hanging();
