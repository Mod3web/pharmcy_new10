...
{
    public partial class Compny_Frm : Form
    {
        public Compny_Frm()
        {
            InitializeComponent();
        ...
        private void Compny_Frm_Load(object sender, EventArgs e)
        {
            ...
            dgv_Compny_dgv.DataSource = DB_Add_delete_update_.Database.ds.Tables["manufctur_company"];
            dgv_Compny_dgv.Columns[0].HeaderText = " رقم الشركة ";
            dgv_Compny_dgv.Columns[1].HeaderText = " الشركة";
        }
        ...
        public void ClareData()
        {
            ...
            int Auto = 1;
            Auto = new classs_table.Items_Tools().AoutoNumber("manufctur_company", "comp_num");

            txt_num.Text = Auto.ToString();
            //int Auto = 1;
            //if (DB_Add_delete_update_.Database.ds.Tables[1].Rows.Count > 0)
            //{
            //    Auto = Convert.ToInt32(DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Compute("max(comp_num)", "")) + 1;
            //    txt_num.Text = Auto.ToString();
            //}
            //else
            //{
        ...
        { 
            ...
            if (txt_com.Text.Trim() != string.Empty) {
                DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Rows.Add(Convert.ToInt32(txt_num.Text), txt_com.Text);
                btn_new_btn.PerformClick();
                dgv_Compny_dgv.DataSource = DB_Add_delete_update_.Database.ds.Tables["manufctur_company"];
                DB_Add_delete_update_.Database.update("manufctur_company");
            }
            else
            {
        ...
        private void Btn_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (dr == DialogResult.OK)
                {
                    ...
                    //DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Rows.RemoveAt(dgv_Compny_dgv.CurrentRow.Index);
        ...
        private void Btn_update_Click(object sender, EventArgs e)
        {
            ...
            if (txt_com.Text.Trim()!=string.Empty) {
                ...
                DB_Add_delete_update_.Database.ds.Tables["manufctur_company"].Rows[dgv_Compny_dgv.CurrentRow.Index][1] = txt_com.Text;
                DB_Add_delete_update_.Database.update("manufctur_company");
        ...
        {
            DataView dv = new DataView(DB_Add_delete_update_.Database.ds.Tables["manufctur_company"]);
